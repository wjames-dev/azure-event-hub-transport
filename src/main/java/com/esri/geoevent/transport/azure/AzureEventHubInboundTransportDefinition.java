...
public class AzureEventHubInboundTransportDefinition extends TransportDefinitionBase {
  ...
  public static final String USE_TRANSPORT_TYPE_AMPQ_PROPERTY_NAME = "useTransportTypeAMPQ";
  public static final String STORAGE_CONTAINER_NAME_PROPERTY_NAME = "storageContainerNameString";
  public static final String DATA_IS_AVRO_ENCODED_PROPERTY_NAME = "dataIsAvroEncoded";
  ...
  public AzureEventHubInboundTransportDefinition() {
    ...
    try {
      propertyDefinitions.put(EVENT_HUB_NAME_PROPERTY_NAME, new PropertyDefinition(EVENT_HUB_NAME_PROPERTY_NAME, PropertyType.String, null, "${com.esri.geoevent.transport.azure-event-hub-transport.EVENT_HUB_NAME_LBL}", "${com.esri.geoevent.transport.azure-event-hub-transport.EVENT_HUB_NAME_DESC}", true, false));
      ...
      propertyDefinitions.put(PROVIDE_EVENT_HUB_CONNECTION_STRING_PROPERTY_NAME, new PropertyDefinition(PROVIDE_EVENT_HUB_CONNECTION_STRING_PROPERTY_NAME, PropertyType.Boolean, new Boolean(false), "${com.esri.geoevent.transport.azure-event-hub-transport.PROVIDE_EVENT_HUB_CONNECTION_STRING_LBL}", "${com.esri.geoevent.transport.azure-event-hub-transport.PROVIDE_EVENT_HUB_CONNECTION_STRING_DESC}", true, false));
      ...
      propertyDefinitions.put(USE_TRANSPORT_TYPE_AMPQ_PROPERTY_NAME, new PropertyDefinition(USE_TRANSPORT_TYPE_AMPQ_PROPERTY_NAME, PropertyType.Boolean, new Boolean(true), "${com.esri.geoevent.transport.azure-event-hub-transport.USE_TRANSPORT_TYPE_AMPQ_PROPERTY_NAME_LBL}", "${com.esri.geoevent.transport.azure-event-hub-transport.USE_TRANSPORT_TYPE_AMPQ_PROPERTY_NAME_DESC}", true, false));
      propertyDefinitions.put(STORAGE_CONTAINER_NAME_PROPERTY_NAME, new PropertyDefinition(STORAGE_CONTAINER_NAME_PROPERTY_NAME, PropertyType.String, null, "${com.esri.geoevent.transport.azure-event-hub-transport.STORAGE_CONTAINER_NAME_PROPERTY_NAME_LBL}", "${com.esri.geoevent.transport.azure-event-hub-transport.STORAGE_CONTAINER_NAME_PROPERTY_NAME_STRING_DESC}", true, false));
      propertyDefinitions.put(DATA_IS_AVRO_ENCODED_PROPERTY_NAME, new PropertyDefinition(DATA_IS_AVRO_ENCODED_PROPERTY_NAME, PropertyType.Boolean, new Boolean(false), "${com.esri.geoevent.transport.azure-event-hub-transport.DATA_IS_AVRO_ENCODED_PROPERTY_NAME_LBL}", "${com.esri.geoevent.transport.azure-event-hub-transport.DATA_IS_AVRO_ENCODED_PROPERTY_NAME_DESC}", true, false));
